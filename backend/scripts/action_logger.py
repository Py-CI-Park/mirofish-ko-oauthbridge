"""
액션 로그 기록기
OASIS 시뮬레이션에서 각 Agent의 액션을 기록하여 백엔드 모니터링에 사용합니다.
...
class ActionLogger:
    """
    액션 로그 기록기(기존 인터페이스 호환)
    대신 SimulationLogManager 사용을 권장합니다.
    """
